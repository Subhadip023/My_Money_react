...
const GuestNavbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-white/80 dark:bg-neutral-800/80 backdrop-blur-md shadow-sm border-b border-neutral-100 dark:border-neutral-700 transition-all">
                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <Link to="/" className="text-2xl font-black tracking-tight flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="px-1.5 py-0.5 rounded text-[10px] font-black bg-indigo-100 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800">
                                BETA
                            </span>
                        </div>
                    </Link>
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-white dark:bg-neutral-800 border-t border-neutral-100 dark:border-neutral-700 px-4 py-6 space-y-4 animate-in fade-in slide-in-from-top-4 duration-200">
                    {navItems.map((item) => (
                        <Link
                            key={item.path}
                            to={item.path}
                            ...
                            className={cn(
                                "block px-4 py-3 rounded-2xl font-bold transition-all",
                                location.pathname === item.path
